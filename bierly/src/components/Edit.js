...
class Edit extends Component {
  ...
  componentDidMount() {
    axios.get('/api/beer/' + this.props.match.params.beerName)
      .then(res => {
  ...
  onSubmit = (e) => {
    ...
    axios.put('/api/beer/' + this.props.match.params.name, { name, brewery, origin, beer_type, notes, intensity, description, pairs_with })
      .then((result) => {
        this.props.history.push('/show/' + this.props.match.params.name);
      });
